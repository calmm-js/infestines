...
},{"core-js/fn/regexp/escape":1,"core-js/shim":294,"regenerator-runtime/runtime":604}],"infestines":[function(require,module,exports){
"use strict";function genAry(aryFs,n){for(var range=function(r,t){return Array(t-r).fill().map(function(t,n){return n+r})},genParams=function(r,t){return range(r,t).map(function(r){return"x"+r}).join(",")},v=aryFs===varyFs?"v":"",_loop=function _loop(total){aryFs[total]=Array(total+1).fill();for(var _loop2=function _loop2(stage){var remains=total-stage,last=v?"default:return "+(remains?function(r){return 1<remains?"curryN("+remains+","+r+")":r}("f("+genParams(0,stage)+")"):"f")+".apply(null,"+(remains?"Array.prototype.slice.call(arguments,"+stage+")":"arguments")+")":"";aryFs[total][stage]=eval("(function "+v+"ary"+stage+"of"+total+"(f){\nreturn function "+v+"curried"+stage+"of"+total+"("+genParams(0,total)+"){\nswitch(arguments.length){\ncase 0:\n"+range(1,total+1).map(function(r){var t="f("+genParams(0,stage)+")";return v&&r<stage&&!remains&&(t="arguments.length==="+(stage-r)+"?"+t+":f.apply(null,["+genParams(0,r)+"].concat(Array.prototype.slice.call(arguments)))"),r<stage&&(t="function("+genParams(r,stage)+"){return "+t+"}"),r<stage&&(total-r!==1||stage-r!==1)&&(t=v+"aryFs["+(total-r)+"]["+(stage-r)+"]("+t+")"),stage<=r&&1<remains&&(t=v+"curryN("+remains+","+t+")"),stage<r&&(t=t+"("+genParams(stage,r)+")"),(v||r<total?"case "+r:"default")+":return "+t}).join("\n")+"\n"+last+"}}})")},stage=1;stage<=total;++stage)_loop2(stage)},total=n;!aryFs[total];--total)_loop(total);return aryFs[n]}function isObject(r){if(!r)return!1;var t=r.constructor;return t===Object||"function"!=typeof t&&Object.getPrototypeOf(r).constructor===Object}function pipe(){switch(arguments.length){case 0:return id;case 1:return arguments[0];case 2:return pipe2.apply(this,arguments);case 3:return pipe3.apply(this,arguments);case 4:return pipe4.apply(this,arguments);default:throw new Error("pipe with "+arguments.length+" fns unsupported")}}function seq(r){for(var t=r,n=arguments.length,e=Array(n>1?n-1:0),a=1;a<n;a++)e[a-1]=arguments[a];for(var i=0,s=e.length;i<s;++i)t=e[i](t);return t}function seqPartial(r){for(var t=r,n=arguments.length,e=Array(n>1?n-1:0),a=1;a<n;a++)e[a-1]=arguments[a];for(var i=0,s=e.length;isDefined(t)&&i<s;++i)t=e[i](t);return t}function whereEqU(r,t){for(var n in r){var e=t[n];if(!isDefined(e)&&!(n in t)||!acyclicEqualsU(r[n],e))return!1}return!0}function hasKeysOfU(r,t){for(var n in r)if(!(n in t))return!1;return!0}function acyclicEqualsArray(r,t){var n=r.length;if(n!==t.length)return!1;for(var e=0;e<n;++e)if(!acyclicEqualsU(r[e],t[e]))return!1;return!0}function acyclicEqualsU(r,t){if(identicalU(r,t))return!0;if(!r||!t)return!1;var n=r.constructor;if(n!==t.constructor)return!1;switch(n){case Array:return acyclicEqualsArray(r,t);case Object:return acyclicEqualsObject(r,t);default:return"function"==typeof r.equals&&r.equals(t)}}function unzipObjIntoU(r,t,n){for(var e in r)t&&t.push(e),n&&n.push(r[e])}function keys(r){var t=[];return unzipObjIntoU(r,t,0),t}function values(r){var t=[];return unzipObjIntoU(r,0,t),t}function assocPartialU(r,t,n){var e={};if(isObject(n))for(var a in n)a!==r?e[a]=n[a]:(e[r]=t,r=void 0);return isDefined(r)&&(e[r]=t),e}function dissocPartialU(r,t){var n=void 0;if(isObject(t))for(var e in t)e!==r?(n||(n={}),n[e]=t[e]):r=void 0;return n}Object.defineProperty(exports,"__esModule",{value:!0}),exports.isObject=isObject,exports.pipe=pipe,exports.seq=seq,exports.seqPartial=seqPartial,exports.whereEqU=whereEqU,exports.hasKeysOfU=hasKeysOfU,exports.acyclicEqualsU=acyclicEqualsU,exports.unzipObjIntoU=unzipObjIntoU,exports.keys=keys,exports.values=values,exports.assocPartialU=assocPartialU,exports.dissocPartialU=dissocPartialU;var aryFs=[[function(r){return 0===r.length?r:function(){return r()}}],Array(2).fill(function(r){return 1===r.length?r:function(t){return r(t)}})],varyFs=[[function(r){return 0===r.length?r:function(){return r.apply(null,arguments)}}],Array(2).fill(function(r){return 1===r.length?r:function(t){return r.apply(null,arguments)}})],curryN=exports.curryN=function(r,t){return getAry(aryFs,r)[Math.min(r,t.length)](t)},arityN=exports.arityN=function(r,t){return getAry(aryFs,r)[r](t)},curry=exports.curry=function(r){return arityN(r.length,r)},vcurryN=exports.vcurryN=function(r,t){return getAry(varyFs,r)[Math.min(r,t.length)](t)},varityN=exports.varityN=function(r,t){return getAry(varyFs,r)[r](t)},vcurry=exports.vcurry=function(r){return varityN(r.length,r)},getAry=function(r,t){return r[t]||genAry(r,t)},id=exports.id=function(r){return r},always=exports.always=function(r){return function(t){return r}},applyU=exports.applyU=function(r,t){return r(t)},sndU=exports.sndU=function(r,t){return t},assert=exports.assert=function(r,t,n){if(t(r))return r;throw new Error(n)},array0=exports.array0=Object.freeze([]),object0=exports.object0=Object.freeze({}),isDefined=exports.isDefined=function(r){return void 0!==r},isArray=exports.isArray=function(r){return!!r&&r.constructor===Array},pipe2=exports.pipe2=function(r,t){return arityN(r.length,function(){return t(r.apply(void 0,arguments))})},pipe3=exports.pipe3=function(r,t,n){return arityN(r.length,function(){return n(t(r.apply(void 0,arguments)))})},pipe4=exports.pipe4=function(r,t,n,e){return arityN(r.length,function(){return e(n(t(r.apply(void 0,arguments))))})},identicalU=exports.identicalU=function(r,t){return r===t&&(0!==r||1/r===1/t)||r!==r&&t!==t},acyclicEqualsObject=exports.acyclicEqualsObject=function(r,t){return whereEqU(r,t)&&hasKeysOfU(t,r)};
